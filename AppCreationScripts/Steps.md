...
1. The .Net client Console app application uses the Active Directory Authentication Library (ADAL) to obtain a JWT access token from Azure Active Directory (Azure AD):
...
```Shell
git clone https://github.com/Azure-Samples/microsoft-identity-dotnet-app-api.git
```
